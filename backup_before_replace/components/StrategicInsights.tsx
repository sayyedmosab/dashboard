...
const StrategicInsights: React.FC<StrategicInsightsProps> = ({ data, onAnalyze, isIntegrationMode, showAnalyzeButtons = true }) => {
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <Panel className="col-span-1">
            <div className="flex justify-between items-start mb-2">
                ...
                {showAnalyzeButtons && <button onClick={() => onAnalyze('insight1')} className="text-sm bg-[var(--dashboard-component-text-accent)] bg-opacity-80 hover:bg-opacity-100 px-3 py-1 rounded-md flex-shrink-0 ml-2">✨ Analyze</button>}
            </div>
        ...
        <Panel className="col-span-1">
            <div className="flex justify-between items-start mb-2">
                ...
                {showAnalyzeButtons && <button onClick={() => onAnalyze('insight2')} className="text-sm bg-[var(--dashboard-component-text-accent)] bg-opacity-80 hover:bg-opacity-100 px-3 py-1 rounded-md flex-shrink-0 ml-2">✨ Analyze</button>}
            </div>
        ...
        <Panel className="col-span-1">
             <div className="flex justify-between items-start mb-2">
                ...
                {showAnalyzeButtons && <button onClick={() => onAnalyze('insight3')} className="text-sm bg-[var(--dashboard-component-text-accent)] bg-opacity-80 hover:bg-opacity-100 px-3 py-1 rounded-md flex-shrink-0 ml-2">✨ Analyze</button>}
            </div>
