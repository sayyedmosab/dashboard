...
const SectorOutcomes: React.FC<SectorOutcomesProps> = ({ 
  outcomes,
  isIntegrationMode = false,
  showAnalyzeButtons = false 
}) => {
    ...
    <section>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <Panel>
              <div className="flex justify-between items-center mb-4"><h3 className="font-semibold">{outcomes.outcome1.title}</h3></div>
              <div className="flex-grow min-h-[250px]"><Chart type="bar" data={outcome1Data} options={outcome1Options} /></div>
          </Panel>
          <Panel>
              <div className="flex justify-between items-center mb-4"><h3 className="font-semibold">{outcomes.outcome2.title}</h3></div>
          ...
          <Panel>
              <div className="flex justify-between items-center mb-4"><h3 className="font-semibold">{outcomes.outcome3.title}</h3></div>
              <div className="flex-grow min-h-[250px]"><Chart type="bar" data={outcome3Data} options={outcome3Options} /></div>
          </Panel>
          <Panel>
              <div className="flex justify-between items-center mb-4"><h3 className="font-semibold">{outcomes.outcome4.title}</h3></div>
